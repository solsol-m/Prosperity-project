...
export async function generateInvoicePDF(tx, t, lang, currency) {
    ...
    <div style="border:1px solid #E2E8F0;border-top:none;border-radius:0 0 20px 20px;
      ...
      <div style="margin-top:32px;padding-top:24px;border-top:1px solid #F1F5F9;
        ...
        <div style="font-size:11px;color:#CBD5E1;">
          ...
          <strong style="color:#10B981;">${isAr ? "إزدهار" : "Prosperity"}</strong> • ${generatedOn}
        </div>
  ...
  try {
    ...
    pdf.save(`${isAr ? "إزدهار" : "Prosperity"}_Invoice_${safeName}_${tx.date}.pdf`);
  } finally {
